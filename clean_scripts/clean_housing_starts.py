...
# File paths
INPUT_FILE = os.path.join("..", "fred_series", "Housing Starts.csv")
OUTPUT_FILE = os.path.join("..", "fred_series_clean", "Housing Starts.csv")
...
# Forward-fill and round to 0 decimal places
